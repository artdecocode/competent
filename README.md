...
| getReplacements | <em>function(): !Array</em>                                                                                                                                                                                                                                        | The function which should return the list of replacements for `renderAgain` method. By default, the initial rule generated by _Competent_ is returned.                                                                                | -       |
