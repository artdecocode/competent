...
| __renderAgain*__ | <em>function(boolean=)</em>         | Render the result of the component again. This is needed when a self-closing component might contain other components when rendered. No recursion is allowed otherwise the program will be stuck.         |
