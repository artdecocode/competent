...
| errorBehaviour | _string_                                                            | Indicates what should be done on error and can be either `REMOVE` or `KEEP`. The former will not print anything to html whereas the latter will keep the detected component as in HTML file.                          | `KEEP`  |
